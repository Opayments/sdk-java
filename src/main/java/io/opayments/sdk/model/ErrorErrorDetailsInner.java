 ...
 */
@JsonPropertyOrder({
  ErrorErrorDetailsInner.JSON_PROPERTY_FIELD,
  ErrorErrorDetailsInner.JSON_PROPERTY_CODE,
  ErrorErrorDetailsInner.JSON_PROPERTY_MESSAGE
})
...
public class ErrorErrorDetailsInner {
  ...
  public ErrorErrorDetailsInner() { 
  }

  public ErrorErrorDetailsInner field(@javax.annotation.Nonnull String field) {
    this.field = field;
    return this;
  }
  ...
  public ErrorErrorDetailsInner code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public ErrorErrorDetailsInner message(@javax.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this Error_error_details_inner object is equal to o.
   */
  @Override
