 ...
 */
@JsonPropertyOrder({
  Refund.JSON_PROPERTY_PAYMENT_ID,
  Refund.JSON_PROPERTY_AMOUNT,
  Refund.JSON_PROPERTY_CURRENCY,
  Refund.JSON_PROPERTY_STATUS,
  Refund.JSON_PROPERTY_REASON,
  Refund.JSON_PROPERTY_FAILURE_CODE,
  Refund.JSON_PROPERTY_FAILURE_MESSAGE,
  Refund.JSON_PROPERTY_ACCEPTED_AT,
  Refund.JSON_PROPERTY_DECLINED_AT,
...
public class Refund {
  ...
  public Refund amount(@javax.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Refund currency(@javax.annotation.Nonnull CurrencyEnum currency) {
  ...
  public Refund failureCode(@javax.annotation.Nullable String failureCode) {
  ...
  public Refund failureMessage(@javax.annotation.Nullable String failureMessage) {
  ...
  public Refund acceptedAt(@javax.annotation.Nullable OffsetDateTime acceptedAt) {
  ...
  public Refund declinedAt(@javax.annotation.Nullable OffsetDateTime declinedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentId, refund.paymentId) &&
        ...
        Objects.equals(this.failureCode, refund.failureCode) &&
        Objects.equals(this.failureMessage, refund.failureMessage) &&
        Objects.equals(this.acceptedAt, refund.acceptedAt) &&
        Objects.equals(this.declinedAt, refund.declinedAt) &&
